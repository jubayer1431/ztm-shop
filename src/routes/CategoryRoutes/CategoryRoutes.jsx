...
const CategoryRoutes = () => {
	...
	return (
		<>
			...
			<CategoryContainer>
				{/*we have to use safe-guards because our categoriesMap relies on async code. That's why categoriesMap is empty when components is rendered first time. that's why we also used dependency array in useEffect hooks.*/}
