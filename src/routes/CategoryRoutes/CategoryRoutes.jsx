...
const CategoryRoutes = () => {
  ...
  // we can use "const products = categoriesMap[category];" instead of useState and useEffect. But, it will be gone if component re-render. that's why we are setting state with useEffect with dependency array of categoriesMap and category (params). So, it will be available after component re-render.
